    ...
    return (
        <div>
            ...
            <div className="info-box">
                ...
                • 🏖️ <strong>Congés Payés (CP)</strong> : acquisition de 2.08 jours par mois (25 jours par an)<br/>
                • 📝 <strong>Congé sans solde</strong> : sur autorisation, non rémunéré, max 5 jours consécutifs<br/>
                • 📅 ⚠️ Les demandes de congé ne peuvent être faites que pour des dates à partir d'aujourd'hui.
            </div>
        </div>
    );
}
